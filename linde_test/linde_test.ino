...
//  pinMode(STEERING_ENABLE, OUTPUT);
 ...
 // analogWrite(GELTONAS, center[1]);
  analogWrite(GAZ_PWM_PIN, GAZ_CENTER);
...
void loop3() {
//  analogWrite(GAZ_PWM_PIN, 1);
//  delay(200);
//  analogWrite(GAZ_PWM_PIN, 127);
//  delay(200);
  for (unsigned short i = GAZ_CENTER; i < 140; i++) {
    analogWrite(GAZ_PWM_PIN, i);
    delay(GAZ_DELAY);
